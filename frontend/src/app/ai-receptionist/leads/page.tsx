  ...
  const handleCreateLead = async (e: React.FormEvent) => {
    ...
    try {
      const created = await leadsApi.create({
        ...
        stage: newLead.stage,
        aiSummary: newLead.aiSummary || "Captured via AI Receptionist console",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-[26px] font-bold text-[#111827] tracking-tight">
            AI Lead Pipeline &amp; Calling Agent
          </h1>
          <p className="text-[13px] text-[#6B7280] mt-0.5">
            Autonomous inbound/outbound AI qualification, voice call summaries &amp; sales conversion (Database Persisted)
          </p>
        </div>
