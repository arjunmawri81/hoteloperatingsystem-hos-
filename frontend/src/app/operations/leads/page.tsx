    ...
    <div className="space-y-6 font-sans antialiased text-[#111827]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-xl border border-[#E5E7EB] shadow-xs">
          <div className="flex items-center justify-between text-[11px] font-bold text-[#6B7280] uppercase">
            <span>Total Pipeline Value</span>
            <TrendingUp className="w-4 h-4 text-blue-500" />
          </div>
          <div className="text-[26px] font-black text-[#111827] mt-1.5">
            ₹{totalPipeline.toLocaleString("en-IN")}
          </div>
          <div className="text-[11px] text-[#6B7280] mt-1">Active hotel revenue pipeline</div>
        </div>

        <div className="bg-white p-5 rounded-xl border border-[#E5E7EB] shadow-xs">
          <div className="flex items-center justify-between text-[11px] font-bold text-emerald-600 uppercase">
            <span>Won &amp; Converted</span>
            <CheckCircle2 className="w-4 h-4 text-emerald-500" />
          </div>
          <div className="text-[26px] font-black text-emerald-700 mt-1.5">
            ₹{convertedTotal.toLocaleString("en-IN")}
          </div>
          <div className="text-[11px] text-[#6B7280] mt-1">Converted to front desk bookings</div>
        </div>

        <div className="bg-white p-5 rounded-xl border border-[#E5E7EB] shadow-xs">
          <div className="flex items-center justify-between text-[11px] font-bold text-purple-600 uppercase">
            <span>AI Voice / Chat Qualified</span>
            <Bot className="w-4 h-4 text-purple-500" />
          </div>
          <div className="text-[26px] font-black text-purple-700 mt-1.5">
            {aiQualifiedCount} Leads
          </div>
          <div className="text-[11px] text-[#6B7280] mt-1">Ready for quotation / booking</div>
        </div>

        <div className="bg-white p-5 rounded-xl border border-[#E5E7EB] shadow-xs">
          <div className="flex items-center justify-between text-[11px] font-bold text-amber-600 uppercase">
          ...
          <div className="text-[11px] text-[#6B7280] mt-1">Phone, WhatsApp &amp; Channel</div>
        </div>
      </div>
